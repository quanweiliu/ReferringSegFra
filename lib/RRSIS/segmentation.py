...
__all__ = ['rrsis', 'rrsis_one']


# LAVT
def _segm_rrsis(pretrained, args):
...
def _load_model_rrsis(pretrained, args):
    model = _segm_rrsis(pretrained, args)
    return model


def rrsis(pretrained='', args=None):
    return _load_model_rrsis(pretrained, args)
...
def rrsis_one(pretrained='', args=None):
